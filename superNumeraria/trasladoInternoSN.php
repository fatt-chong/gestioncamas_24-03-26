...
<body topmargin="5" style="font-family:Arial, Helvetica, sans-serif; font-size:12px">
	...
	<table background="../ingresos/img/fondo.jpg" width="850px" align="center" border="2" bordercolor="#000000" bordercolorlight="#FFFFFF" bordercolordark="#666666" cellspacing="0" cellpadding="0">
...
?>
    ...
    while($camas = mysql_fetch_array($query)){
		...
		if ($sala <> $camas['sala']){
			...
			?>
			<td>
			<fieldset><legend style='font-size:9px' >S-<? echo $camas['sala']; ?></legend>
