...
if ($_GET["calendario"]){$fecha_selected = $_GET["calendario"]; $fecha_selected = date("Y-m-d",strtotime($fecha_selected)); }
$fechahoy = date("d-m-Y");
...
<table align="center" border="2" bordercolor="#000000" bordercolorlight="#FFFFFF" bordercolordark="#666666" cellspacing="0" cellpadding="0" background="img/fondo.jpg">
    <tr height="20px" align="left" bgcolor="#006699" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#FFF">
        ...
        <tr>
            ...
            <td width="24" align="right"><input type="text" id="calendario" name="calendario" class="calendario" size="10px" placeholder ="<?=date("d-m-Y");?>" value="<?=date("d-m-Y",strtotime($fecha_selected));?>" onchange="document.frm_camas.submit();"/></form></td>
        </tr>
        </table>
        </td>
    </tr>    
        	...
        	<tr>
                ...
                <fieldset><legend style="font-size:10px;">s-<? echo $salaPensionado; ?></legend>
                	<table cellspacing="1px">
                    	<? $sqlCamasPensio = "SELECT camas.camas_log.id, camas.camas_log.tipo_traslado, camas.camas_log.que_cod_servicio, camas.camas_log.que_servicio, camas.camas_log.cod_servicio,
											camas.camas_log.servicio, camas.camas_log.sala, camas.camas_log.cama, camas.camas_log.tipo_1, camas.camas_log.d_tipo_1, camas.camas_log.tipo_2,
											camas.camas_log.d_tipo_2, camas.camas_log.epiId, camas.camas_log.nom_paciente, camas.camas_log.cod_prevision, camas.camas_log.prevision,
											camas.camas_log.fecha_ingreso, camas.camas_log.hora_ingreso, camas.camas_log.usuario_que_ingresa, camas.camas_log.fecha_usuario_ingresa,
											pensionado.lista.numPensio, pensionado.lista.salaPensio, camas.camas_log.estado, camas.camas_log.categorizacion_riesgo, camas.camas_log.categorizacion_dependencia,
											camas.camas_log.sexo_paciente, camas.camas_log.multires, camas.camas_log.diagnostico1, camas.camas_log.nom_paciente
											FROM camas.camas_log
											INNER JOIN pensionado.lista ON camas.camas_log.cama = pensionado.lista.idPensio
											WHERE camas.camas_log.cam_log_fecha = '$fecha_selected' and tipo_1 = 46 and sala = '$salaPensionado'"; 
						...
						while($arrayCamasPensio = mysql_fetch_array($queryCamasPensio)){
								...
								$idPensioPen = $arrayCamasPensio['cama'];
								$salaPensioPen = $arrayCamasPensio['salaPensio'];
								$corrCamaPen = $arrayCamasPensio['id'];
								$estadoCamaPen = $arrayCamasPensio['estado'];
								$catRiesgoPen = $arrayCamasPensio['categorizacion_riesgo'];
								$catDepPen = $arrayCamasPensio['categorizacion_dependencia'];
								$sexoCamaPen = $arrayCamasPensio['sexo_paciente'];
								$multiCamaPen = $arrayCamasPensio['multires'];
								$pacienteSNPen = $arrayCamasPensio['nom_paciente'];
...
/***** modificacion danny para dias hospitalizados 08-01-2014	*****/
	...
	$hoyPensio = $fecha." ".$Time;		
						$hoyPensio;
						$ingresoPensio = $arrayCamasPensio['fecha_ingreso'].' '.$arrayCamasPensio['hora_ingreso'];
	...
	/* fin del calculo danny para dias hospitalizados 08-01-2014 */
						...
						$ingresoPensio = $arrayCamasPensio['fecha_ingreso'].' '.$arrayCamasPensio['hora_ingreso'];
						$ingreso_hospPensio = $arrayCamasPensio['hospitalizado'];
						$egresoPensio = $hoy;
...
$infPacientePen = "<b>- Paciente</b> : ".$arrayCamasPensio['nom_paciente']."<br/><b>- Ingreso Hospital</b> : ".cambiarFormatoFecha2(substr(($arrayCamasPensio['hospitalizado']),0,10))." - ".substr($arrayCamasPensio['hospitalizado'],11,15)." Hrs."."<br/><b>- Dias Hospitalizado </b> : ".$diass." dias ".$horass." horas ".$minutoss." minutos <br /><b>- Ingreso al Servicio</b> : ".cambiarFormatoFecha2($arrayCamasPensio['fecha_ingreso'])." - ".$arrayCamasPensio['hora_ingreso']." Hrs."."<br/><b>- Dias en el Pensionado </b> : ".$diass." dias ".$horass." horas ".$minutoss." minutos <br /><b>- M�dico</b> : ".$arrayCamasPensio['n_medicoPensio']."<br/><b>- Pre Diagn�stico</b> : ".$arrayCamasPensio['diagn1Pensio']."<br/><b>- Diagn�stico</b> : ".$arrayCamasPensio['diagn2Pensio']."<br/><b>- Categorizacion</b> : ".$categorizacionPen." ( ".cambiarFormatoFecha2($arrayCamasPensio['cat_fechaPensio'])." )<br />";
...
$infPacientePen = "<b>- Paciente</b> : ".$arrayCamasPensio['nombrePensio']."<br/><b>- Ingreso Hospital</b> : ".cambiarFormatoFecha2(substr(($arrayCamasPensio['hospPensio']),0,10))." - ".substr($arrayCamasPensio['hospPensio'],11,15)." Hrs."."<br/><b>- Dias Hospitalizado </b> : ".$dias_espera_hospPensio." dias y ".$horas_espera_hospPensio." horas <br /><b>- Ingreso al Servicio</b> : ".cambiarFormatoFecha2($arrayCamasPensio['fechaIngresoPensio'])." - ".$arrayCamasPensio['horaIngresoPensio']." Hrs."."<br/><b>- Dias en el Pensionado </b> : ".$dias_esperaPensio." dias y ".$horas_esperaPensio." horas <br /><b>- M�dico</b> : ".$arrayCamasPensio['n_medicoPensio']."<br/><b>- Pre Diagn�stico</b> : ".$arrayCamasPensio['diagn1Pensio']."<br/><b>- Diagn�stico</b> : ".$arrayCamasPensio['diagn2Pensio']."<br/><b>- Categorizacion</b> : ".$categorizacionPen." ( ".cambiarFormatoFecha2($arrayCamasPensio['cat_fechaPensio'])." )<br />";
							 ...
							 fin de la copia linea vivi */
								...
								$estiloCamaPen = " class='td_sscc'";
								$infPacientePen = "<b>- Cama Bloqueada desde: </b>".cambiarFormatoFecha2(substr(($arrayCamasPensio['hospitalizado']),0,10))." <br/><b> - Motivo: </b>".$arrayCamasPensio['diagnostico1']."<br/><b> - Paciente: </b>".$pacienteSNPen;
								...
								$infPacientePen = "<b>- Cama Bloqueada desde: </b>".cambiarFormatoFecha2(substr(($arrayCamasPensio['fecha_ingreso']),0,10))." <br/><b> - Diagnostico: </b>".$arrayCamasPensio['diagnostico1']."<br/><b> - Paciente: </b>".$pacienteSNPen;
        ...
        <!-- FIN PENSIONADO -->
			...
			mysql_connect ('10.6.21.12','gestioncamas','123gestioncamas');
			mysql_select_db('camas') or die('Cannot select database');
			$query = mysql_query("SELECT * FROM camas_log where cam_log_fecha = '$fecha_selected' and cod_servicio = $servicio order by sala, cama") or die(mysql_error());
    ...
    <td valign="top">
				...
				switch ($camas['estado']){
					...
					case 5:
						//$sqlCamaSN = mysql_query("SELECT * FROM camas_log WHERE cam_log_fecha = '$fecha_selected' and que_idcamaSN = $id_cama"); 
						//$arrayCamaSN = mysql_fetch_array($sqlCamaSN);
						
						$inf_paciente = "<b>- Cama Bloqueada Desde</b> : ".cambiarFormatoFecha2($camas['fecha_ingreso'])."<br /> <b>- Paciente</b> : ".$camas['nom_paciente']."<br /> <b>- Pre-Diagnostico</b> : ".$camas['diagnostico1'];			
						//<br /> <b>- Sala </b> : ".$arrayCamaSN['que_salaSN']."<b> Cama </b> : ".$arrayCamaSN['que_camaSN']."<br /> <b>- Servicio:</b> : ".$arrayCamaSN['desde_nomServSN']." // esta linea esta cortada de arriba
...
<tr>
<td>
            <fieldset style="padding-left:15px"> <legend style="font-size:16px">Resumen <strong>Hospital</strong> ( No Considera Urgencia, Hospitalizaci&oacute;n Domiciliaria y Partos ) &nbsp;&nbsp;<? echo cambiarFormatoFecha2($fecha_selected)." - ".$hora_hoy." Hrs."; ?>
</legend>
