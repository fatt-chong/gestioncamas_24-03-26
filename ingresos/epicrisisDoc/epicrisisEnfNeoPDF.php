...
//CONEXIONES A BD
$a=mysql_connect ('10.6.21.26','usuario','hospital');
...
$epiEnfermera = $resInforme['epienfEnfermera'];
$epiResp = $resInforme['epienfResp'];
$epiRespNom = $resInforme['epienfRespNom'];
$epiRespRut = $resInforme['epienfRespRut'];
$epiPesoNac = $resInforme['epienfPesoNac'];
$epiPesoAlta = $resInforme['epienfPesoAlta'];
$epiFono = $resInforme['epienfFono'];
...
<table width="700" border="0">
  ...
  <tr>
    ...
    <table width="100%" align="left" cellpadding="1" style="font-size:9;">
            ...
            <tr>
            	<td><strong>Peso al Nacer:</strong></td>
                <td>'.$epiPesoNac.'</td>
                <td><strong>Peso al Alta:</strong></td>
                <td colspan="3">'.$epiPesoAlta.'</td>
  ...
  <tr>
    <td colspan="3" align="left" valign="bottom"><strong>Indicaciones medicas, de enfermeria y horarios.</strong></td>
  </tr> 
  <tr>
  	<td colspan="3" valign="top"><hr /></td>
  </tr> 
...
$conn_id = ftp_connect($ftp_server, 21, 1); 
$login_result = ftp_login($conn_id, "epicrisisEnfermera", "epicrisisEnfermera");
