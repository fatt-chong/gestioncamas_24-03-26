...
window.onload=function(){
	setInterval('barthel(ingresa_doc)',10);	
}
</script>
...
<form id="ingresa_doc" name="ingresa_doc" method="get" action="pro2_modificaingreso.php">
    ...
    <input type="hidden" name="id_cama" value="<? echo $id_cama ?>" />
        ...
        <fieldset class="fieldset_det2">
            <table width="830px" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td width="10px">&nbsp;</td>
					<td>Servicio Clinico : <input size="20" type="text" name="pservicio" value="<?php echo $desc_servicio; ?>" readonly="readonly"/> Sala : <input size="10" type="text" name="psala" value="<?php echo $sala ?>" readonly="readonly" /> Cama N° : <input size="3" type="text" name="pcama" value="<?php echo $cama ?>" readonly="readonly" />Correspondie a... 
	...
	<fieldset class="fieldset_det2"><legend>Paciente</legend>
		  <table width="830px" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr>
                ...
                <input size="2" type="text" name="categorizacion" value="<?php echo $categorizacion ?>" readonly="readonly" />
              	</td>
    ...
    <fieldset class="fieldset_det2"><legend>Hospitalización</legend>
        <table width="830px" border="0" cellspacing="1" cellpadding="1">
			<tr>
            	...
            	Procedencia
                <? if ( array_search(310, $permisos) != null ){ ?>
            ...
            <? if(($cod_servicio <> 6) && ($cod_servicio <> 7)){ ?>
                <tr>
                	<td>&nbsp;</td>
                    <td>I. Barthel: </td>
            ...
            <tr>
                            ...
                            <td></td>
                <td>Fecha Ingreso</td>
                <td><input size="9"  id="f_date1" type="text" name="fecha_ingreso"  value="<? echo $fecha_ingreso ?>" 
