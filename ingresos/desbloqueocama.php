...
//UTILIZADO PARA VERIFICAR EL ESTADO DE LA CAMA

$sqlVerifica = "SELECT * FROM camas where id = '".$id_cama."'";
$queryVerifica = mysql_query($sqlVerifica) or die("ERROR AL SELECCIONAR CAMA ".mysql_error());
...
<body background="../../estandar/img/fdo.jpg" topmargin="5" style="font-family:Arial, Helvetica, sans-serif; font-size:12px">
	<table width="850px" align="center" border="2" bordercolor="#000000" bordercolorlight="#FFFFFF" bordercolordark="#666666" cellspacing="0" cellpadding="0">
    	<th height="20px" align="left" bgcolor="#006699" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#FFF">&nbsp; Desbloqueo de Cama.</th>
...
<fieldset class="fieldset_det2"><legend>Error</legend>
    	<table style="font-size:18px; color: #F00;" align="center" border="0" cellspacing="0" cellpadding="0">
        	    ...
        	    <tr>
            	    <td align="center">La cama seleccionada ha sido</td>
	            </tr>
    	        <tr>
        	        <td align="center">utilizada como super numeraria.</td>
            	</tr>
...
<? } ?>
	...
	<div align="center" >
		...
		<a class='titulo'>Informaci�n de Cama Bloqueada.</a>
        ...
        <fieldset class="fieldset_det2">
            <table width="780px" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                    <td width="10px">&nbsp;</td>
					<td>Servicio Clinico : <input size="25" type="text" name="pservicio" value="<?php echo $desc_servicio; ?>" readonly="readonly"/> Sala : <input size="15" type="text" name="pcama" value="<?php echo $sala; ?>" readonly="readonly" /> Cama N� : <input size="3" type="text" name="pcama" value="<?php echo $cama; ?>" readonly="readonly" /> </td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset class="fieldset_det2"> <legend>Opciones</legend>
            <table align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <? 
						if($_SESSION['MM_pro_estado'] != 5){
							if($estadoCama != 5){ ?>
						<input type="button" class="boton" <?php if ( array_search(20, $permisos) == null ) { ?> disabled="disabled" <? } ?> onclick="window.location.href='<? echo"pro1_desbloqueocama.php"; ?>'; parent.GB_hide(); " value=" Desbloquear Cama " />
                        <? }
						} ?>
...
<fieldset><legend>Historial Ocupaci�n de Cama</legend>
	...
	<div align="center" style="width:100%;height:50px;overflow:auto">
        ...
        <table width="97%" id="table_desbloqueocama" border="2px" cellpadding="1px" cellspacing="0px">
			...
			while($paciente = mysql_fetch_array($query)){
                ...
                onClick="window.location.href='<? echo"desbloqueocama.php?id_cama=$id_cama&id_hosp=$id_hosp&cama=$cama&sala=$sala&servicio=$servicio&desc_servicio=$desc_servicio&estado=$estado"; ?>'; parent.GB_hide(); ">
