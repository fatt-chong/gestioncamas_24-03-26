...
<table width="70%" align="center" border="0" cellspacing="0" cellpadding="0">
	<tr align="left">
		<td>
			<fieldset>
			<legend>Informacion de Regreso</legend>
		...
		<form method="get" action="pro2_regresadepabellon.php">
	...
	<tr align="left">
		<td>
			<fieldset>
			<legend>� Esta Seguro de Realizar Regreso de Paciente desde Pabell�n ?</legend>
