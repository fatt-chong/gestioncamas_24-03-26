...
<script type="text/javascript" src="../superNumeraria/include/funciones/funcionesJavaScript.js"></script>
...
<table width="855" border="0" style="border:1px solid #000000;" align="center" cellpadding="2" cellspacing="2" background="img/fondo.jpg">
    <tr>
        <th height="25" align="left" bgcolor="#006699" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#FFF">Ingresar Paciente
</th>
    </tr>
    <tr>
        <td>
            	...
            	<td>
                    ...
                    <table width="100%">
                        <tr>
                          ...
                          <td colspan="3" width="23%"><input name="pacServicio" type="text" id="pacServicio" value="<? echo $nomServicio; ?>" style="width:150px" readonly="readonly" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <a id="ver" style="cursor:pointer;" title="Abrir Calendario"><img src="../superNumeraria/img/calendar.jpg" alt="" /></a></td>
                        </tr>
                        <tr>
                          <td>Hora Ingreso:</td>
                          <td colspan="3">
  ...
  <input name="minuto_ingreso" type="text" id="minuto_ingreso" style="width:18px" value="<? if($minuto_ingreso != '') echo $minuto_ingreso; else echo soloMinuto();?>" onkeypress="return validaNumeros(event);" onblur="return formatoMinutoIngreso(document.getElementById('minuto_ingreso'));" maxlength="2" /></td>
            ...
            <tr>
                <td>
						...
						<table width="100%">
							<tr>
                                <td align="center"><input type="button" name="registrar" id="registrar" value="   Aceptar   " onclick="document.form1.action='pro3_ingresopacienteSN.php'; document.form1.submit();"/>
                                <input type="button" name="atras" id="atras" value="   Cancelar   " onclick="javascript: document.location.href='ingresopacienteSN.php'" /></td>
                            </tr>
                        </table>
						</fieldset>
					</td>
        ...
        <? }else{ ?>
            ...
            <br />
            <input type="button" name="atras" id="atras" value="   Volver   " onclick="javascript: document.location.href='ingresopacienteSN.php'" />
            </div>
            </fieldset>
        <? } ?>
		</td>
