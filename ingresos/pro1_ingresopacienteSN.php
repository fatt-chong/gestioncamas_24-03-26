...
$sqlServicios = mysql_query("SELECT DISTINCT
							...
							acceso.servicio.idservicio = 10319 ") or die ("ERROR AL SELECCIONAR INFORMACION DE TRANSITO PACIENTE ".mysql_error());
?>
...
<body>
<form name="elegirCama" id="elegirCama">
	<table  border="0" style="border:1px solid #000000;" align="center" cellpadding="4" cellspacing="2" background="../ingresos/img/fondo.jpg">
    	<tr>
        	<th height="25" align="left" bgcolor="#006699" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#FFF">Seleccionar Cama
 </th>
   		</tr>
        <tr>
        	<td>
                    ...
                    <table width="50%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr valign="top">
                            ...
                            <table align="center">
								...
								$enlace = "href='pro2_ingresopacienteSN.php?idPaciente=$id_paciente&idTransito=$id_traslado&idServicio=$codServicio&que_sala=$que_sala&que_cama=$que_cama&que_idcama=$que_idcama&que_causa=$que_causa&que_estado=$que_estado&que_fechaBloq=$que_fechaBloq'";
        ...
        <tr>
            ...
            <table width="100%">
                <tr>
                    <td align="right"><input type="button" name="atras" id="atras" value="   Atras   " onclick="javascript: document.location.href='ingresopacienteSN.php'" /></td>
                </tr>
            </table>
            </fieldset>
            </td>
