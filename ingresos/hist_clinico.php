                                                ...
                                                <tr align="left" height="25px" style="font-size:10px; font-family:Verdana, Arial, Helvetica, sans-serif; cursor:pointer;"
													<? $regAId = $list_paciente['regAId'];
														if($list_paciente['regAtipoExamen'] == 'P') 
															...
															echo " onClick='javascript: window.open(\"http://localhost:8080/anatomiaPatologica/servlet/adiagnostico2?$regAId\",\"\",\"titlebars=0,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,height=800,width=1000\")';";
