...
<body background="../../estandar/img/fdo.jpg" topmargin="5" style="font-family:Arial, Helvetica, sans-serif; font-size:12px">
	<table width="850px" align="center" border="2" bordercolor="#000000" bordercolorlight="#FFFFFF" bordercolordark="#666666" cellspacing="0" cellpadding="0">
    	  <th height="20px" align="left" bgcolor="#006699" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#FFF">&nbsp; Hospitalizaci&oacute;n de Paciente Cama SN.
</th>
...
mysql_select_db('camas') or die('Cannot select database');
	...
	<form name="ingresa_doc" method="get" action="pro1_ingresopacienteSN.php">
	<div align="center"> 
...
<?
    ...
    if ($d_t_pac_transito == 1) {
        ...
        $cuantos_pac = "<a href='ingresopacienteSN.php?t_pac_transito=off'; > Mostrar solo los pacientes en transito del servicio de ".$desc_servicio."</a>";
    }
    else {
        $sql_p_transito = "SELECT * FROM transito_paciente where cod_sscc_hasta = $id_rau order by fecha";
        $cuantos_pac = "<a href='ingresopacienteSN.php?t_pac_transito=on'; > Mostrar los pacientes en transito de todos los servicios.</a>";
    }
?>
...
//					$desc_sscc_hasta = $traslados['desc_sscc_hasta'];
                    ...
                    <tr style="font-size:10px; font-family:Verdana, Arial, Helvetica, sans-serif"
                    	onClick="window.location.href='<? echo "pro1_ingresopacienteSN.php?tipodocumento=5&id_paciente=$id_paciente&id_traslado=$id_traslado"; ?>'; parent.GB_hide(); ">
					
                    <td align='left' style='padding-left:2px; padding-right:10px'><? echo $nom_paciente; ?></td>
                    <td align='left' style='padding-left:2px; padding-right:10px'><? echo $rut_paciente; ?></td>
                    <td align='left' style='padding-left:2px; padding-right:10px' ><? echo $desc_sscc_desde; ?></td>
                    <td align='left' style='padding-left:2px; padding-right:10px' ><? echo $desc_sscc_hasta; ?></td>
                    <td align='left' style='padding-left:3px; padding-right:10px' ><? echo $fecha; ?></td>
