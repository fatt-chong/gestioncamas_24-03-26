...
<tr><td width="20px" height="20px"></td><td width="140px"></td></tr>
	...
	<form name="form1" method="post" action="pro2_bloqueocama.php">

        <table width="70%" align="center" border="0" cellspacing="0" cellpadding="0">
        <tr align="left">
        <td>
        <fieldset></br>
        <legend>� Esta seguro de Realizar el Boqueo de Cama ?</legend>
        ...
        <tr><td></td><td> Fecha </td>
            <td><input size="12" id="f_date4" name="fecha_ingreso" value="<? echo $fecha_hoy ?>" /> <input type="Button" id="f_btn4" value="....." />
            </td></tr>
        <tr><td></td><td> Motivo de Bloqueo </td><td> <input type="text" size="60" name="diagnostico1" /> </td></tr>
        <tr><td width="20px" height="20px"></td><td width="140px"></td></tr>
        <tr><td></td><td> <input type="submit" value="          Aceptar          " >
            </td><td><input type="button" value="      Cancelar      " onclick="window.location.href='<? echo"ingresopaciente.php?id_cama=$id_cama&cama=$cama&sala=$sala&servicio=$servicio&desc_servicio=$desc_servicio&estado=$estado"; ?>'; parent.GB_hide(); " /></td></tr>
	        <tr><td width="20px" height="20px"></td><td width="140px"></td></tr>        
        </table>
