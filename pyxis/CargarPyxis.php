		...
		if ($extension == 'unl'){
			...
			while ($data = fgetcsv ($fp, 1000, "|")) {
				...
				if($codservicio == 10322){
					...
					$rau = mysql_pconnect('10.6.21.26', 'gestioncamas', '123gestioncamas') or trigger_error(mysql_error(),E_USER_ERROR); 
				...
				else
				{
					...
					$farmacos = mysql_pconnect('10.6.21.26', 'gestioncamas', '123gestioncamas') or trigger_error(mysql_error(),E_USER_ERROR); 
					...
					$aba = mysql_pconnect('10.6.21.26', 'gestioncamas', '123gestioncamas') or trigger_error(mysql_error(),E_USER_ERROR); 
					...
					if ($tipo == 'C') {
						...
						$egresodetalle = mysql_pconnect('10.6.21.26', 'gestioncamas', '123gestioncamas') or trigger_error(mysql_error(),E_USER_ERROR); 
						...
						$delete = mysql_pconnect('10.6.21.26', 'gestioncamas', '123gestioncamas') or trigger_error(mysql_error(),E_USER_ERROR); 
