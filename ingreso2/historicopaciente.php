...
<body background="../../estandar/img/fdo.jpg" topmargin="5" style="font-family:Arial, Helvetica, sans-serif; font-size:12px">
	<table width="850px" align="center" border="2" bordercolor="#000000" bordercolorlight="#FFFFFF" bordercolordark="#666666" cellspacing="0" cellpadding="0">
    	<th height="20px" align="left" bgcolor="#006699" style="font-size:16px; font-family:Arial, Helvetica, sans-serif; color:#FFF">&nbsp; Historico de Hospitalizaciones de Paciente.</th>
	...
	<div align="center" >
        ...
        <fieldset class="fieldset_det2"><legend>Historial de Paciente</legend>
	...
	<fieldset>
        <table width="770px" height="170px" border="0" cellspacing="1" cellpadding="1">
            ...
            <td>
                ...
                <table width="97%" id="table_detallecama" border="2px" cellpadding="1px" cellspacing="0px">
                    <tr>
                ...
                onClick="window.location.href='<? echo"historicopaciente.php?id_cama=$id_cama&id_hosp=$id_hosp&nom_paciente=$nom_paciente&id_paciente=$id_paciente"; ?>'; parent.GB_hide(); ">
