...
$ev_7= $_GET['ev_7'];
$ev_8= $_GET['ev_8'];
$total_riesgo= $_GET['total_riesgo'];
...
$ev_13= $_GET['ev_13'];
$ev_14= $_GET['ev_14'];
$total_dependencia= $_GET['total_dependencia'];
$categorizacion_dependencia= $_GET['categorizacion_dependencia'];
$observacion= $_GET['observacion']; 
$categorizacion_final= $_GET['categorizacion_final'];
$btn_aceptar= $_GET['btn_aceptar'];       
$d_smpt= $_GET['d_smpt'];
	...
	if ($resultado2)
		{
			...
			?>
			<input type="button" class="boton" onclick="window.location.href='aprecoz.php'" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Salir &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
