...
$estado = $_SESSION['MM_pro_estado'];
	...
	?>
	<form name="busca_paciente" method="get" action="busquedapacientes3.php">
	    ...
	    <fieldset class="fieldset_det2"><legend>Busqueda de Paciente</legend>
            ...
            ?>
                ...
                <table id="demo_table" cellpadding="3" cellspacing="0" border="1" width="90%" align="center">
                    	...
                    	<th colspan="5">
                        	<input type="button" value=" << " onClick="window.location.href='<? echo"busquedapacientes3.php?apellidopat=$apellidopat&apellidomat=$apellidomat&nombres=$nombres&desde=$desdemenos&totalreg=$totalreg"; ?>'; parent.GB_hide(); " <? if ($desde == 0) {  echo "disabled='disabled'";  }   ?> > 
                        	Indice de Pacientes Página <? echo $nropagina."/".$totalpag ?>
                        	<input type="button" value=" >> " onClick="window.location.href='<? echo"busquedapacientes3.php?apellidopat=$apellidopat&apellidomat=$apellidomat&nombres=$nombres&desde=$desdemas&totalreg=$totalreg"; ?>'; parent.GB_hide(); " <? if ($totalpag == $nropagina) { echo "disabled='disabled'"; }   ?> >
                        </th>
                    </tr>
                    ...
                    <tr style="font-size:12px; font-family:Verdana, Arial, Helvetica, sans-serif"><th>Nro</th><th>Apellido Paterno</th><th>Apellido Materno</th><th>Nombres</th><th>Rut</th></tr>
                        ...
                        while($pacientes = mysql_fetch_array($query)){
                            ...
                            onClick="window.location.href='<? echo"../ingreso2/pro1_ingresopaciente.php?tipodocumento=6&id_paciente=$idpaciente"; ?>'; parent.GB_hide(); ">
		...
		<input type="Button" value="        Cancelar        " onClick="window.location.href='<? echo"../ingreso2/ingresopaciente.php?id_cama=$id_cama"; ?>'; parent.GB_hide(); " >	
