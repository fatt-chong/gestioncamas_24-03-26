...
if ($d_censo_minsal == 1)
{
	$pag_ant = "?censo_minsal=on&fecha_censo=$fecha_censo&cod_servicio=$cod_servicio";
}
else
{
	$pag_ant = "?fecha_censo=$fecha_censo&cod_servicio=$cod_servicio";
}
	...
	$cod_destino = $paciente['cod_destino'];
	...
	$fecha_egreso = cambiarFormatoFecha2($paciente['fecha_egreso']);
          	...
          	<fieldset>
	            ...
	            <fieldset>
	                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    	<tr>
                        	<td align="center"><a class='titulo'> Modificar Datos de Hospitalización </a></td>
                        </tr>
                    </table>
                </fieldset>
				...
				<div align="center">
					...
					<form name="frmFormulario" method="post" action="gr_modifica_hosp_censo.php">
                        ...
                        <input type="hidden" name="pag_ant" value="<? echo $pag_ant ?>" />
                        <input type="hidden" name="act" id="act" value="0" />
                        <input type="hidden" name="id_hosp" value="<? echo $id_hosp ?>" />
                        ...
                        <fieldset class="fieldset_det2"><legend>Hospitalización</legend>
                            <table width="780px" border="0" cellspacing="1" cellpadding="1">
                                <tr>
                                    ...
                                    <td><select name="cod_medico" disabled="disabled">
                                    <?php
                                ...
                                <tr>
                                    <td></td>
                                    <td>Pre-Diagnnostico</td>
                                    <td><input size="103" type="text" name="diagnostico1" value="<?php echo $diagnostico1; ?>" disabled="disabled" /></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Diagnostico</td>
                                    <td><input size="103" type="text" name="diagnostico2" value="<?php echo $diagnostico2; ?>" disabled="disabled" /></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="cod_auge" disabled="disabled">
                        ...
                        <fieldset class="fieldset_det2"><legend>Hospitalización</legend>
                            <table width="780px" border="0" cellspacing="1" cellpadding="1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input size="9"  id="f_date1" type="text" name="fecha_ingreso"  value="<? echo $fecha_ingreso ?>" /><input type="Button" id="f_btn1" value="...." />
                                    </td>
                                    <td>
                                        Procedencia
                                    </td>
                                    ...
                                    <td>
                                        Cta - Cte..
                                          <input size="8" type="text" name="cta_cte" value="<? echo $cta_cte; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td>
                                        <input size="9"  id="f_date2" type="text" name="fecha_egreso"  value="<? echo $fecha_egreso ?>" /><input type="Button" id="f_btn2" value="...." />
                                    </td>
                                    <td>
                                        Destino
                                    </td>
                                    <td>
                                        ...
                                        for($i=0; $i<count($servicios); $i++)
                                        {
                                            if ($id_servicios[$i] < 50 or $id_servicios[$i] > 100)
                                            {
                        ...
                        <fieldset><legend>Opciones</legend>
                            ...
                            <input type="button" value=    "       Cancelar       " onclick="window.location.href='mantencion_censo.php<? echo $pag_ant ?>'; parent.GB_hide(); " />
                            
                            <input type="button" name="btnGrabar" id="btnGrabar" value="    Eliminar    " onclick="javascript:if (confirm ('Esta Seguro de Eliminar Registro ?')) { document.getElementById('act').value='1'; document.frmFormulario.submit();} " />
                        </fieldset>
                    </form>
